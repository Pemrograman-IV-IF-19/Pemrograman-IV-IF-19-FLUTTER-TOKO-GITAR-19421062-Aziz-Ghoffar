...
class _MyProfileState extends State<MyProfile> {
  String username = "", namaLengkap = "", email = "", notlp = "";
  final _globalKey = GlobalKey<ScaffoldState>();

  TextEditingController emailController = new TextEditingController();
  TextEditingController namaLengkapController = new TextEditingController();
  TextEditingController usernameController = new TextEditingController();
  TextEditingController notlpController = new TextEditingController();
  ...
  void getProfile() async {
    ...
    setState(() {
      ...
      notlp = sharedPreferences.getString('notlp').toString();
